...
- **[v0.2] Theme assets** for the first Tree: the logo and fonts of https://ai4sfs.org,
  ...
  logo is the owner's instruction (#35), and the owner confirmed on #73 that the logo
  stays in the repository (10.25).
