...
- `docs/specs/application.md`: #119 amends 5.1 to 5.4 (the loader reads `tree.json`),
  #120 fills 16.1 to 16.3, #121 fills 15 and 16.5, #122 fills 16.4. This freeze writes
  15 and 16 in full, so no build issue has to create a section another is also creating.
