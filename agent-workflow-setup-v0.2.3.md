# The ORCA ADE agent workflow: complete setup (v0.2.3)
    ...
    steps:
      ...
      - name: Verifier agent
        ...
        with:
          ...
          claude_args: "--max-turns 80 --allowedTools Bash,Read,Glob,Grep,Skill"
          prompt: |
    ...
    steps:
      ...
      - name: Reviewer agent
        ...
        with:
          ...
          claude_args: "--max-turns 60 --allowedTools Bash,Read,Glob,Grep,Skill"   # see the Verifier step's note
          prompt: |
