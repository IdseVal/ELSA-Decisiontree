...
test('the browser asks for the images of the Node on screen and no others', async ({ page }) => {
  // The root Node's own Image is its main image (10.3); an Option's first Image is
  // on its Branch (10.3), one file asked for once. Neither page asks for the other's.
